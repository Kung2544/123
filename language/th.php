...
return array(
  ...
  'Please make sure the above options are correct. Based on the selected options, the data will be imported.' => 'กรุณาตรวจสอบตัวเลือกด้านบนให้ถูกต้อง ระบบจะนำเข้าข้อมูลตามตัวเลือกที่เลือก',
  ...
  'The language code of the CSV file used for data import-export' => 'รหัสภาษาของไฟล์ CSV สำหรับการ นำเข้า-ส่งออก ข้อมูล',
  ...
  'To import, just insert data into the original file as in this example' => 'การนำเข้าให้ใส่ข้อมูลลงในไฟล์ต้นฉบับตามตัวอย่างนี้เท่านั้น',
  ...
  'YEAR_OFFSET' => 543,
  'You can edit the file and can re-import the same file again This means updating the information according to the latest files.' => 'คุณสามารถแก้ไขไฟล์ และนำเข้าไฟล์เดิมซ้ำอีกครั้งได้ ซึ่งหมายถึงการอัปเดทข้อมูลให้เป็นไปตามไฟล์ล่าสุด',
