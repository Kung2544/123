        ...
        if (!$error) {
            ...
            try {
                ...
                if (!$db->tableExists($table)) {
                    $db->query("CREATE TABLE `$table_dms_meta` (`dms_id` int(11) NOT NULL,`type` varchar(20) COLLATE utf8_unicode_ci NOT NULL,`value` text COLLATE utf8_unicode_ci NOT NULL) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci");
